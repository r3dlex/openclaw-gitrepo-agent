defmodule GitrepoAgent.MqClient do
  @moduledoc """
  ...
  - IAMQ_AGENT_ID: This agent's ID (default: gitrepo_agent)
  ...
  @default_agent_id "gitrepo_agent"
  ...
  defp route_request(message) do
    ...
    cond do
      ...
      String.contains?(subject, "score") or String.contains?(subject, "scoring") ->
        Logger.info("[MQ] Scoring request from #{from}")
