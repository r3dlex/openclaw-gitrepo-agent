...
2. Send full report to `librarian_agent` via IAMQ (with base64-encoded attachments)
...
6. Deliver full report to `librarian_agent` via IAMQ and broadcast summary to the swarm
